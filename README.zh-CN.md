...
> **接续维护的分支。** 原作者为 [liwenhao0427](https://github.com/liwenhao0427)（磁石战士Ω），维护至 v1.30（2026 年 6 月）后停更。本仓库经原作者书面授权继续维护与分发，并从[原创意工坊条目](https://steamcommunity.com/sharedfiles/filedetails/?id=3747538947)互相链接。感谢磁石战士Ω 打下的基础！
...
目前尚无正式开源许可证；原作者已于 2026-07-27 书面授权本分支维护与分发本 Mod。在 LICENSE 文件落地之前，请将源码视为*仅供个人使用的源码可用（source-available）*状态——二次分发衍生品前请先询问。
