...
| 17 | `CardSelectManualConfirmationPatch` | `CardSelectCmd` | `FromDeckForUpgrade` | nameof | **verified** | `D:\Download\pain\sts2src\src\Core\Commands\CardSelectCmd.cs (L537)` |
| 18 | `CardSelectManualConfirmationPatch` | `CardSelectCmd` | `FromDeckForTransformation` | nameof | **verified** | `D:\Download\pain\sts2src\src\Core\Commands\CardSelectCmd.cs (L589)` |
| 19 | `CardSelectManualConfirmationPatch` | `CardSelectCmd` | `FromDeckGeneric` | nameof | **verified** | `D:\Download\pain\sts2src\src\Core\Commands\CardSelectCmd.cs (L742)` |
...
| 87 | `NEndTurnButtonLifecyclePatch` | `NEndTurnButton` | `SetState` | 字符串 | **verified** | `D:\Download\pain\sts2src\src\Core\Nodes\Combat\NEndTurnButton.cs (L217)` |
| 88 | `NEndTurnButtonLifecyclePatch` | `NEndTurnButton` | `OnTurnStarted` | 字符串 | **verified** | `D:\Download\pain\sts2src\src\Core\Nodes\Combat\NEndTurnButton.cs (L247)` |
| 89 | `NEndTurnButtonLifecyclePatch` | `NEndTurnButton` | `OnAboutToSwitchToEnemyTurn` | 字符串 | **verified** | `D:\Download\pain\sts2src\src\Core\Nodes\Combat\NEndTurnButton.cs (L242)` |
| 90 | `NEndTurnButtonLifecyclePatch` | `CombatManager` | `AfterAllPlayersReadyToBeginEnemyTurn` | 字符串 | **verified** | `D:\Download\pain\sts2src\src\Core\Combat\CombatManager.cs (L684)` |
| 91 | `NEndTurnButtonLifecyclePatch` | `NCombatUi` | `Activate` | 字符串 | **verified** | `D:\Download\pain\sts2src\src\Core\Nodes\Combat\NCombatUi.cs (L130)` |
