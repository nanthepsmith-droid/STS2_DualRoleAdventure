...
> ⑦ **Phase 0 已实现（r107，2026-09-10，已部署 ⏳ 待实机复测）**：新增「瓦库托管视角」三档
...
> ⑧ **r108（实机反馈修复，2026-09-10，已部署 ⏳ 待复测）**：① 用户实测「不跟随」下**仍要真人替瓦库选**
...
> ⑨ **r109（新 bug 修复，2026-09-10，已部署 ⏳ 待复测）**：瓦库打「手牌变换」类牌（YUI「数据链」、
...
> ⑩ **r110（历史小尾巴清理，2026-09-10，已部署 ⏳ 待复测）**：① **清理期异常降级** —— 退出这一局时
